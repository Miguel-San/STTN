...
##python train.py --config configs/twin_jet_develop_scaled_vg.json --model sttn
python test_custom.py --config configs/twin_jet_develop_scaled_vg.json --model sttn --ckpt 4000 --ds_name full_ds_1e4
date