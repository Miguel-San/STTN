...
##python train.py --config configs/twin_jet_develop_scaled.json --model sttn
##python train.py --config configs/davis.json --model sttn
python test_custom.py --config configs/twin_jet_develop_scaled.json --model sttn --ckpt 3000 --ds_name full_ds
date